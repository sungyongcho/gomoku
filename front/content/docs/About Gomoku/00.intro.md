...
A full-stack Gomoku AI system featuring a **C++ minimax engine** with bitboard evaluation and a **Python AlphaZero implementation** trained on a GCP Ray cluster (the served model was trained from scratch in the fourth of four runs: 222 of the 265 total iterations), 19×19 board with custom capture and double-three rules, native C++ MCTS extensions, and a Nuxt.js frontend with real-time WebSocket play.

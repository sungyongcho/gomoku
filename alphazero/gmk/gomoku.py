...
class Gomoku:
    ...
    def get_initial_state(self) -> np.ndarray:
        ...
        return GameState(board=board, p1_pts=0, p2_pts=0)
    ...
    def get_next_state(
        ...
        return GameState(board=board, p1_pts=p1_pts, p2_pts=p2_pts)

    def get_legal_moves(self, state: GameState, player: int) -> list[str]:
